        ...
        try:
            ...
            with self.subTest(event=f"{CAN_API}/{api_verb}_1", expected=expected):
                ...
                with self.assertEventEmitted(
                    ...
                    timeout_ms=5000,
                    value=expected,
                    value_lambda=get_event_value_from_data,
                ):
                    _send_encoded(
                        bus,
                        msg,
            ...
            with self.subTest(event=f"{CAN_API}/{api_verb}_2", expected=expected):
                ...
                with self.assertEventEmitted(
                    ...
                    _send_encoded(
                        bus, msg, {"MUX_signal": 1, "speed": 0, "temperature": 0}
                    )
    ...
    def test_mux_0_signal_event_emitted(self):
        ...
        try:
            _send_encoded(
                bus,
                msg,
                {"MUX_signal": 0, "open": 0, "closed": 0, "direction": 0, "mode": 0},
            )
        ...
        try:
            ...
            with self.subTest(event=f"{CAN_API}/{api_verb}", expected=expected):
                ...
                with self.assertEventEmitted(
                    ...
                    _send_encoded(
                        bus, msg, {"MUX_signal": 1, "speed": 51, "temperature": 0}
                    )
            ...
            with self.subTest(event=f"{CAN_API}/{api_verb}", expected=expected):
                ...
                with self.assertEventEmitted(
                    ...
                    _send_encoded(
                        bus, msg, {"MUX_signal": 1, "speed": 0, "temperature": 37}
                    )
